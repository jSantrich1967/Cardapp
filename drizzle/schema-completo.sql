-- CardOps: esquema completo para Neon
-- Ejecuta este archivo en Neon SQL Editor antes de importar respaldos
-- (Si dice "ya existe", usa schema-solo-tablas.sql en su lugar)

DO $$ BEGIN
  CREATE TYPE "card_status" AS ENUM ('active', 'inactive');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
  CREATE TYPE "operation_type" AS ENUM ('RECARGA', 'PROCESADA', 'FEE_VZLA', 'FEE_MERCHANT');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
